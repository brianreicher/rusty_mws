...
class CorrectedSegTest(unittest.TestCase):
    def generate_fragments(self) -> None:
        ...
        task_completion: bool = rusty_mws.blockwise_generate_mutex_fragments_task(sample_name="test",
    ...
    def test_skeleton_correction(self) -> None:
        task_completion: bool = rusty_mws.skel_correct_segmentation(raster_file="../data/raw_predictions.zarr",
